...
SECRET_KEY = 'django-insecure-g7^$j8f3k9m2p5q6r8s1t4u7v0w3x6y9z2a5b8c1d4e7f0g3h6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['anaconda2121.pythonanywhere.com']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        ...
        'gym.permissions.HasActiveSubscription',
    ),
}
